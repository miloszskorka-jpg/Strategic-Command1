...
// ─── Icon asset URLs ──────────────────────────────────────────────────────────
const imgArrowDown = "http://localhost:3845/assets/499d016dbf1d3dd6eddd71d3de4c390e4b8b8292.svg";
    ...
    <div className="relative shrink-0 size-[16px] mr-1">
      <div className="absolute inset-[8.33%]">
        <img
          ...
          src={status === "error" ? imgCancel : imgCheck}
        />
      </div>
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 size-[16px]">
      <div
        ...
        style={{
          inset: open
            ? "29.17% 13.63% 29.75% 16.67%"
            : "29.17% 13.63% 29.88% 16.67%",
          containerType: "size" as React.CSSProperties["containerType"],
        }}
      >
        <div
          className={`flex-none h-[100cqw] w-[100cqh] ${
            open ? "-rotate-90 -scale-x-100" : "-rotate-90"
          }`}
        >
