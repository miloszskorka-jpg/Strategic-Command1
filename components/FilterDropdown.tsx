...
// ─── Icon asset URLs ──────────────────────────────────────────────────────────
const imgArrowDown = "http://localhost:3845/assets/0349c0fd4d5d670ed10d1b770946410ff62e3c85.svg";
const imgArrowUp   = "http://localhost:3845/assets/648db749a03322442130a1144632c99197570277.svg";
const imgClose     = "http://localhost:3845/assets/604ff059791d97d74fb160ba7cfb7aa1090d636b.svg";
  ...
  return (
    <div className="relative shrink-0 size-[16px]">
      <div
        ...
        style={{ inset: "29.17% 13.63% 29.75% 16.67%", containerType: "size" as React.CSSProperties["containerType"] }}
      >
        <div className={`flex-none h-[100cqw] w-[100cqh] ${open ? "-rotate-90 -scale-x-100" : "-rotate-90"}`}>
          <div className="relative size-full">
            <img
              alt={open ? "close" : "open"}
              className="absolute block inset-0 max-w-none size-full"
              src={open ? imgArrowUp : imgArrowDown}
            />
          </div>
        </div>
      </div>
  ...
  return (
    <div className="relative shrink-0 size-[16px]">
      <div className="absolute inset-[22.63%_22.58%_22.58%_22.62%]">
        <img alt="clear" className="absolute block inset-0 max-w-none size-full" src={imgClose} />
      </div>
    </div>
  );
}
